...
re_frame.utils.log.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq(["Handling re-frame event: ",v], 0));
...
re_frame.utils.group.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq(["clojure.data/diff for: ",v], 0));
...
var G__12495 = db;
var G__12496 = cljs.core.vec(cljs.core.rest(v));
return (handler.cljs$core$IFn$_invoke$arity$2 ? handler.cljs$core$IFn$_invoke$arity$2(G__12495,G__12496) : handler.call(null,G__12495,G__12496));
});
});
/**
...
while (G__12497__i < G__12497__a.length) {G__12497__a[G__12497__i] = arguments[G__12497__i + 0]; ++G__12497__i;}
  args = new cljs.core.IndexedSeq(G__12497__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__12498){
var args = cljs.core.seq(arglist__12498);
...
var G__12513 = (handler.cljs$core$IFn$_invoke$arity$2 ? handler.cljs$core$IFn$_invoke$arity$2(db,v) : handler.call(null,db,v));
var G__12514 = v;
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__12515_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,new_ins){
return (function (p1__12516_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,p1__12516_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__12517__i < G__12517__a.length) {G__12517__a[G__12517__i] = arguments[G__12517__i + 2]; ++G__12517__i;}
  in_paths = new cljs.core.IndexedSeq(G__12517__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__12518){
var f = cljs.core.first(arglist__12518);
arglist__12518 = cljs.core.next(arglist__12518);
var out_path = cljs.core.first(arglist__12518);
var in_paths = cljs.core.rest(arglist__12518);
