...
if((i < len)){
var k = (ks[i]);
var G__12055 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12056 = (i + (1));
m = G__12055;
i = G__12056;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12060 = c;
var G__12060__$1 = (((G__12060 == null))?null:G__12060.prototype);
if((G__12060__$1 == null)){
return null;
} else {
return (G__12060__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12064 = c;
var G__12064__$1 = (((G__12064 == null))?null:G__12064.prototype);
if((G__12064__$1 == null)){
return null;
} else {
return (G__12064__$1["render"]);
}
})()));
});
...
return (function() { 
var G__12068__delegate = function (args){
...
while (G__12069__i < G__12069__a.length) {G__12069__a[G__12069__i] = arguments[G__12069__i + 0]; ++G__12069__i;}
  args = new cljs.core.IndexedSeq(G__12069__a,0);
} 
return G__12068__delegate.call(this,args);};
...
return G__12068__delegate(args);
});
...
var _STAR_current_component_STAR_12073 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12073;
}});
...
var G__12081 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12081) {
...
return ((function (G__12081){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12084 = reagent.impl.component.state_atom(c);
var G__12085 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12084,G__12085) : cljs.core.reset_BANG_.call(null,G__12084,G__12085));
});
;})(G__12081))
...
var or__5945__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__12087_12089 = (c["cljsRatom"]);
if((G__12087_12089 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12087_12089);
}
...
if(cljs.core.truth_((function (){var and__5933__auto__ = wrap;
...
var renders_12092 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12093 = cljs.core.first(cljs.core.vals(renders_12092));
if((cljs.core.count(renders_12092) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_12092))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_12093)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12093], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__5945__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__5945__auto__)){
return or__5945__auto__;
} else {
...
var render_fun__$1 = (function (){var or__5945__auto__ = render_fun;
if(cljs.core.truth_(or__5945__auto__)){
return or__5945__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__5945__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__5945__auto__)){
return or__5945__auto__;
} else {
...
var name__$1 = (function (){var G__12091 = name;
switch (G__12091) {
case "":
...
var elem = (function (){var G__12102 = (function (){var or__5945__auto__ = (function (){var G__12104 = c;
if((G__12104 == null)){
return null;
} else {
return (G__12104["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__5945__auto__)){
return or__5945__auto__;
...
return (G__12102["_currentElement"]);
}
})();
var name = (function (){var G__12105 = elem;
var G__12105__$1 = (((G__12105 == null))?null:(G__12105["type"]));
if((G__12105__$1 == null)){
return null;
} else {
return (G__12105__$1["displayName"]);
}
})();
var path = (function (){var G__12106 = elem;
var G__12106__$1 = (((G__12106 == null))?null:(G__12106["_owner"]));
var G__12106__$2 = (((G__12106__$1 == null))?null:reagent$impl$component$component_path(G__12106__$1));
if((G__12106__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12106__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__5945__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__5945__auto__)){
return or__5945__auto__;
} else {
var G__12108 = c;
var G__12108__$1 = (((G__12108 == null))?null:G__12108.constructor);
if((G__12108__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12108__$1);
}
}
})();
