...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__6551__auto__,writer__6552__auto__,opt__6553__auto__){
return cljs.core._write(writer__6552__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__12130 = o;
(G__12130[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__12131__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__12131 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__12132__i = 0, G__12132__a = new Array(arguments.length -  0);
while (G__12132__i < G__12132__a.length) {G__12132__a[G__12132__i] = arguments[G__12132__i + 0]; ++G__12132__i;}
  args = new cljs.core.IndexedSeq(G__12132__a,0);
} 
return G__12131__delegate.call(this,args);};
G__12131.cljs$lang$maxFixedArity = 0;
G__12131.cljs$lang$applyTo = (function (arglist__12133){
var args = cljs.core.seq(arglist__12133);
return G__12131__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__5933__auto__ = cljs.core.some_QMARK_(reagent.impl.template.find_dom_node);
if(and__5933__auto__){
var and__5933__auto____$1 = cljs.core.some_QMARK_(jsprops);
if(and__5933__auto____$1){
var and__5933__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__12138 = jsprops;
(G__12138["defaultValue"] = value);

(G__12138["onChange"] = ((function (G__12138,v,value,on_change){
return (function (p1__12136_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12136_SHARP_);
});})(G__12138,v,value,on_change))
);
...
var vec__12143 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12143,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12143,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12143,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12146 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12146 == null)){
} else {
var key_12147 = temp__4661__auto___12146;
(jsprops["key"] = key_12147);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12149 = (new reagent.impl.template.NativeWrapper());
(G__12149["name"] = c);
...
var G__12151 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12151) : reagent.impl.template.as_element.call(null,G__12151));
} else {
...
var len__7014__auto___12157 = arguments.length;
var i__7015__auto___12158 = (0);
while(true){
if((i__7015__auto___12158 < len__7014__auto___12157)){
args__7021__auto__.push((arguments[i__7015__auto___12158]));

var G__12159 = (i__7015__auto___12158 + (1));
i__7015__auto___12158 = G__12159;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7022__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12155){
var G__12156 = cljs.core.first(seq12155);
var seq12155__$1 = cljs.core.next(seq12155);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12156,seq12155__$1);
});
...
break;
default:
var G__12163 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12163;
continue;
...
var n__6859__auto___12164 = a.length;
var i_12165 = (0);
while(true){
if((i_12165 < n__6859__auto___12164)){
(a[i_12165] = reagent.impl.template.as_element((a[i_12165])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__6859__auto___12167 = a.length;
var i_12168 = (0);
while(true){
if((i_12168 < n__6859__auto___12167)){
var val_12169 = (a[i_12168]);
if((cljs.core.vector_QMARK_(val_12169)) && ((reagent.impl.template.key_from_vec(val_12169) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12168] = reagent.impl.template.as_element(val_12169));

var G__12170 = (i_12168 + (1));
i_12168 = G__12170;
continue;
} else {
}
...
var ctx = {};
var vec__12172 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12172,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12172,(1),null);
...
var G__12174 = (cljs.core.count(argv) - first_child);
switch (G__12174) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12174){
